...
**Бележка за документацията, вградена в 3.9.4:** Публикуваният Setup е неизменен snapshot, създаден преди следпубликационното съгласуване. Някои от вече включените в него документи (`START_HERE.txt`, `Documentation/UPDATES.md`, `USER_MANUAL.md`, `RECYCLER_USER_GUIDE.md`, `PASSWORD_RECOVERY.md`) могат да съдържат по-ранни формулировки за текущата версия, включително „Stable candidate“, 3.9.3 или 3.8.1. Това не променя версията на изпълнимия файл: текущият официален Stable се определя от настоящия публичен release и `update/stable-manifest.json`. Онлайн документацията в `main` е актуализирана, но коригирането на копията **в самия вече публикуван Setup** изисква нова отделно квалифицирана версия; бинарните файлове и тагът `v3.9.4` не се подменят.
